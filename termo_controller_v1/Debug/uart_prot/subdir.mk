...
CPP_SRCS += \
../uart_prot/uart_prot.cpp 

OBJS += \
./uart_prot/uart_prot.o 

CPP_DEPS += \
./uart_prot/uart_prot.d 


# Each subdirectory must supply rules for building sources it contributes
uart_prot/%.o uart_prot/%.su: ../uart_prot/%.cpp uart_prot/subdir.mk
...
clean: clean-uart_prot

clean-uart_prot:
	-$(RM) ./uart_prot/uart_prot.d ./uart_prot/uart_prot.o ./uart_prot/uart_prot.su

.PHONY: clean-uart_prot
